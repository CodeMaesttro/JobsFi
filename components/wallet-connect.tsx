  ...
  return (
    <div className="relative">
      {isConnected ? (
        <Button
          variant="outline"
          className="border-purple-400 text-white hover:bg-purple-900/20 text-sm"
      ...
      {connectionError && (
        <div className="absolute right-0 mt-2 w-64 rounded-md bg-red-900/80 p-2 text-xs text-white z-50">
          {connectionError}
      ...
      {showMetaMaskSimulation && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
          <div className="relative w-full max-w-md rounded-lg bg-white p-0 shadow-lg mx-4">
            {/* MetaMask Header */}
                ...
                <div className="text-center">
                  ...
                  <div className="mb-4 rounded-lg bg-gray-100 p-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-sm text-gray-700">hirechain.io</span>
                    </div>
                  </div>
                </div>
              )}

...
import { Briefcase, Building2, Clock, DollarSign, FileUp, Globe, MapPin, Sparkles, Upload, Wallet } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-950 to-gray-900">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <EarlyAccessBanner jobId={job.id} isEarlyAccess={job.isEarlyAccess} releaseDate={job.publicReleaseDate} />
          ...
          <div className="space-y-8">
            <div className="rounded-xl bg-gray-800/50 p-6 backdrop-blur-sm">
              <div className="flex items-center gap-2">
                ...
                {job.isEarlyAccess && (
                  <div className="rounded-full bg-gradient-to-r from-purple-500/20 to-blue-500/20 px-2 py-1 text-xs font-medium text-purple-300 flex items-center gap-1">

    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-950 to-gray-900">
      ...
      <main className="container mx-auto px-4 py-12">
        <div className="mx-auto max-w-4xl">
          <h1 className="mb-8 text-center text-4xl font-bold text-white">About JobsFi</h1>
          ...
          <div className="mb-16 rounded-xl bg-gray-800/50 p-8 backdrop-blur-sm">
            ...
            <p className="mb-6 text-lg text-gray-300">
              JobsFi is on a mission to bridge the gap between talented professionals and innovative blockchain
            ...
            <div className="grid gap-8 md:grid-cols-3">
              <div className="text-center">
                <div className="mx-auto mb-4 h-24 w-24 overflow-hidden rounded-full bg-purple-900/50">
                  <div className="flex h-full items-center justify-center text-4xl font-bold text-purple-400">AH</div>
                </div>
                <h3 className="text-xl font-bold text-white">Abdul Razak Abdul Hafiz</h3>
                <p className="text-purple-400">Smart Contract Developer</p>
                 
              </div>

              <div className="text-center">
                <div className="mx-auto mb-4 h-24 w-24 overflow-hidden rounded-full bg-blue-900/50">
                  <div className="flex h-full items-center justify-center text-4xl font-bold text-blue-400">AK</div>
                </div>
                <h3 className="text-xl font-bold text-white">Adul Razak Kamil Nyaba</h3>
                <p className="text-purple-400">Full Stack Developer</p>
               </div>

              <div className="text-center">
                <div className="mx-auto mb-4 h-24 w-24 overflow-hidden rounded-full bg-purple-900/50">
                  <div className="flex h-full items-center justify-center text-4xl font-bold text-purple-400">NH</div>
                </div>
                <h3 className="text-xl font-bold text-white">Namhan</h3>
                <p className="text-purple-400">Marketing Strategist</p>
               
              </div>
               <div className="text-center">
                <div className="mx-auto mb-4 h-24 w-24 overflow-hidden rounded-full bg-purple-900/50">
                  <div className="flex h-full items-center justify-center text-4xl font-bold text-purple-400">SH</div>
                </div>
                <h3 className="text-xl font-bold text-white">Shahida</h3>
                <p className="text-purple-400">PRO</p>
